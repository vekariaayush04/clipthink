...
export default function AuthPage() {
  ...
  return (
    <div className="flex-1 max-h-screen bg-background flex items-center justify-center p-4">
                        ...
                        <FormItem>
                          ...
                          <FormControl>
                            <div className="relative">
                              <Mail className="absolute left-3 top-3 h-4 w-4 text-muted-foreground hover:bg-transparent" />
                              <Input
                                type="text"
